    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div class="glass-card bg-white/5 dark:bg-black/5 backdrop-blur-lg border border-white/10 dark:border-white/5 rounded-2xl p-8">
        <div class="text-center mb-8">
          <h2 class="text-3xl font-bold text-white mb-4">Neue Anfrage</h2>
        ...
        <div class="max-w-2xl mx-auto">
          <form @submit.prevent="submitRequest" class="space-y-6">
            <!-- Service Type -->
            <div>
              <label class="block text-white font-medium mb-2">Art des Service</label>
              <select v-model="form.serviceType" class="w-full bg-white/5 border border-white/20 rounded-lg px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent">
            ...
            <!-- Location -->
            <div>
              <label class="block text-white font-medium mb-2">Standort</label>
              <input 
                v-model="form.location" 
                type="text" 
                placeholder="Beschreiben Sie Ihren aktuellen Standort..."
                class="w-full bg-white/5 border border-white/20 rounded-lg px-4 py-3 text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent"
              >
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label class="block text-white font-medium mb-2">Fahrzeugmarke</label>
                <input 
              ...
              <div>
                <label class="block text-white font-medium mb-2">Fahrzeugmodell</label>
                <input 
            ...
            <!-- Problem Description -->
            <div>
              <label class="block text-white font-medium mb-2">Problembeschreibung</label>
              <textarea 
            ...
            <!-- Contact Info -->
            <div>
              <label class="block text-white font-medium mb-2">Telefonnummer (optional)</label>
              <input 
                v-model="form.phone" 
                type="tel" 
            ...
            <!-- Priority -->
            <div>
              <label class="block text-white font-medium mb-2">Dringlichkeit</label>
              <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                <label class="flex items-center space-x-3 bg-white/5 border border-white/20 rounded-lg px-4 py-3 cursor-pointer hover:bg-white/10 transition-colors">
            ...
            <div class="text-center pt-4">
              <button 
                ...
                :class="[isFormValid ? 'bg-orange-500/30 hover:bg-orange-500/40 text-orange-400 border-orange-400/30' : 'bg-gray-500/20 text-gray-500 border-gray-500/30 cursor-not-allowed']"
                class="glass-button border px-8 py-3 rounded-lg transition-all duration-300 text-lg font-semibold"
              >
                Anfrage Senden
              </button>
            </div>
